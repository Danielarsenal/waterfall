...
window.CP.PenTimer = {
    ...
    _throwAnErrorToStopPen: function () {
        throw "We found an infinite loop in your Pen. We've stopped the Pen from running. Pleas" +
            "e correct it or contact support@codepen.io."
    },
        ...
        this
            .each(function () {
                ...
                function getNbCols() {
                    ...
                    var colWidth = container
                        .find(prm.columnClass)
                        .outerWidth(true);
                ...
                function print() {
                    ...
                    for (var i in elemsDatas) {
                        var html = '';
                        var content = elemsDatas[i].content != undefined
                            ? elemsDatas[i].content
                            : '';
                        var href = elemsDatas[i].href != href
                            ? elemsDatas[i].href
                            : '';
                        var classe = elemsDatas[i].class != undefined
                            ? elemsDatas[i].class
                            : '';
                        var id = elemsDatas[i].id != undefined
                            ? elemsDatas[i].id
                            : '';
